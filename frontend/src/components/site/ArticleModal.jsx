...
export const ArticleModal = ({ article, onClose }) => {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[100] bg-[color:var(--mc-secondary)]/70 backdrop-blur-sm flex items-stretch justify-center overflow-y-auto"
      onClick={onClose}
    >
      <div
        className="relative w-full max-w-[920px] my-0 md:my-12 bg-white shadow-2xl"
        ...
        <article className="px-6 md:px-16 py-12 md:py-20">
          ...
          <div className="mt-14 pt-8 border-t border-[color:var(--mc-line)] flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
            <p className="text-[13px] text-[color:var(--mc-muted)] max-w-[420px]">
              Perspectives published by MiCells. For enquiries on any of the
              themes discussed, please contact us.
            </p>
            <a
              href="#contact"
              onClick={onClose}
